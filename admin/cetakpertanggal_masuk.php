...
where tgl like '$_POST[tanggal]%' and jenis='Masuk' order by kode asc");
?>
...
<body onLoad="javascript:print()">
							...
							<tr>
							<td><div align="center">
							  <h4 align="center" class="style1">Laporan Kas Masuk Gang mawar </h4></td>
							</tr>
							</table>
                        </div>
...
<br>
							  <div style="font-style:italic" class="col-lg-12 col-md-4" align="right">
